							...
							<div className="right-column">
								<div id="preview-shadow">
									<div id="preview">
										...
										<h3>What I Do</h3>
										<p>
											I am helping business to automate
											their work
										</p>
					...
					<div className="main-container">
						<div className="about-wrapper">
							<div className="about-me">
								...
								<p>
									I Build new project just to tickle my brain
									and love teaching others how to made them
								</p>

								<p>
									While i Keep Busy teaching course, I still
									take interviews in search of great team
								...
								<p>
									Fullstack devloper with primary focus on
									Nodejs + React:{" "}
